var About, Cart, DEBUG, Error404, FAQ, FAQ1, FAQ2, FAQ3, Generator, Home, Thankyou, ThemesGiftCard, ThemesOthers, ThemesRSVP, ThemesSeatingCard, ThemesThankYouCard, ThemesWeddingCard, app, appendFont, detectBrowserLang, detectInFBApp, float, focusFirstInput, forceDownload, headerTo, htmlDecode, htmlEncode, inArray, isAndroid, nl2br, routeRedirect, router, routes, scrollTop, xx;
...
Cart = {
  ...
  mounted: function() {
    if (this.$parent.$parent.wedding_mate_1 !== '') {
      this.wedding_mate_1 = this.$parent.$parent.wedding_mate_1;
    }
    if (this.$parent.$parent.wedding_mate_2 !== '') {
      this.wedding_mate_2 = this.$parent.$parent.wedding_mate_2;
    }
    if (this.$parent.$parent.wedding_date !== '') {
      this.wedding_date = this.$parent.$parent.wedding_date;
    }
    if (this.$parent.$parent.wedding_time !== '') {
      this.wedding_time = this.$parent.$parent.wedding_time;
    }
    if (this.$parent.$parent.wedding_location !== '') {
      this.wedding_location = this.$parent.$parent.wedding_location;
    }
    if (this.$parent.$parent.wedding_address !== '') {
      this.wedding_address = this.$parent.$parent.wedding_address;
    }
...
Generator = {
  ...
  methods: {
    ...
    add_to_cart: function() {
      var item;
      this.$parent.$parent.wedding_mate_1 = this.wedding_mate_1;
      this.$parent.$parent.wedding_mate_2 = this.wedding_mate_2;
      this.$parent.$parent.wedding_date = this.wedding_date;
      this.$parent.$parent.wedding_time = this.wedding_time;
      this.$parent.$parent.wedding_location = this.wedding_location;
      this.$parent.$parent.wedding_address = this.wedding_address;
